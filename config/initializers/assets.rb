...
# ASSETS_HOST = ENV.fetch('SHIPLIX_ASSETS_HOST', ENV.fetch('SHIPLIX_HOST', "shiplix.local"))
...
Rails.application.config.assets.precompile += %w(front.css front.js *.png *.jpg *.gif)
